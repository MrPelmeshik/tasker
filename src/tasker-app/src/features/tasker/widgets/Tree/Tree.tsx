...
export interface TreeProps extends WidgetSizeProps {
  ...
  /** Общий ref обработанного deep link (дедуп при смене режима Активности/Календарь на TaskerPage) */
...
export const Tree: React.FC<TreeProps> = ({ colSpan, rowSpan, initialDeepLink, processedDeepLinkKeyRef, embedded, externalDnd, dragEndRef }) => {
